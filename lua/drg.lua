...
function get_sets()
	...
	ValorousMask = {}
	ValorousMask.WSD = { name="Valorous Mask", augments={'Accuracy+19 Attack+19','Weapon skill damage +5%','Accuracy+9','Attack+13',}}
	
	ValorousMitts = {}
	ValorousMitts.WSD = { name="Valorous Mitts", augments={'Accuracy+21','Weapon skill damage +5%','Attack+7',}}
	...
	ValorousBody = {}
	ValorousBody.STP = { name="Valorous Mail", augments={'Accuracy+16 Attack+16','"Store TP"+7','STR+6','Attack+14',}}
	
	ValorousHose = {}
	ValorousHose.DATP = { name="Valor. Hose", augments={'Attack+27','"Dbl.Atk."+3','STR+9','Accuracy+5',}}
	...
	Brig = {}
	Brig.DATP = { name="Brigantia's Mantle", augments = {'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10','Phys. dmg. taken-10%',}}
...
-------------------------------
	...
	sets.Idle.Standard = {
        ...
        head={ name="Valorous Mask", augments={'Accuracy+19 Attack+19','Weapon skill damage +5%','Accuracy+9','Attack+13',}},
    ...
    sets.SAMRoll = {}
    sets.SAMRoll.index = { 'CappedHaste', 'AccuracyLite', 'AccuracyMid', 'AccuracyFull' }
    SAMRoll_ind = 1 -- In the same rule as the TP Toggle so it toggles it at the same time

    sets.SAMRoll.CappedHaste = set_combine(sets.TP.CappedHaste, {        
		neck = "Ganesha's Mala",
		ear1 = "Brutal Earring",
	...
	--Shell V on. Need 23% when 5/5 with pants, 21% with sheltered ring (24 with sheltered and trust)--
		sets.DT.MDTV = {
		ammo = "Staunch Tathlum +1",
		head = "Flamma Zucchetto +2",
	...
	sets.Stardiver.index = { 'Attack', 'MidAcc', 'HighAcc' }
	Stardiver_ind = 1
	...
	sets.CamlannsTorment.Attack = {
		...
		ear1 = { name="Moonshade Earring", augments={'Accuracy+4','TP Bonus +250',}},
		ear2 = "Sherida Earring",
        body = { name="Valorous Mail", augments={'Mag. Acc.+11','Weapon skill damage +4%','STR+10','Accuracy+5','Attack+5',}},
...
function set_style(sheet)
	...
	add_to_chat (56, 'Sola Scriptura.')
	add_to_chat (55, 'You are on '..('DRG. '):color(5)..''..('Fly high. '):color(55)..''..('Macros set!'):color(121))
--	add_to_chat (23, '"I merely chewed in self defense, but I never swallowed"')
end
...
AllowSkillchainGear = true   --Whether or not hte skillchainPending system should be disabled
...
function status_change(new, old)
	...
	if player.status == 'Engaged' and TH == true and spell.type ~= "WeaponSkill" then
