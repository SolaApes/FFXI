...
function init_gear_sets()
	...
	sets.engaged.Normal = {
		...
		hands="Wakido Kote +3",
        legs={ name="Rao Haidate +1", augments={'Accuracy+25','"Dbl.Atk."+4','Pet: Accuracy+25',}},
	...
	sets.dt = {
        ...
        body={ name="Valorous Mail", augments={'Accuracy+16 Attack+16','"Store TP"+7','STR+6','Attack+14',}},
        hands="Wakido Kote +3",
	...
	sets.precast.WS = {
        ...
        hands={ name="Valorous Mitts", augments={'Accuracy+21','Weapon skill damage +5%','Attack+7',}},
        legs="Wakido Haidate +3",
        feet={ name="Valorous Greaves", augments={'Accuracy+27','Weapon skill damage +3%','DEX+10','Attack+8',}},
        neck="Fotia Gorget",
        waist="Fotia Belt",
        ...
        back={ name="Smertrios's Mantle", augments={'STR+20','Accuracy+20 Attack+20','Accuracy+6','Weapon skill damage +10%',}},
	}
