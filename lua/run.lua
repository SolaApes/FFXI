...
function get_sets()
	...
	AdhemarJacket = {}
	AdhemarJacket.TP = { name="Adhemar Jacket +1", augments={'STR+12','DEX+12','Attack+20',}}
	AdhemarJacket.FC = { name="Adhemar Jacket", augments={'HP+80','"Fast Cast"+7','Magic dmg. taken -3',}}
	...
	TaeonBody = {}
	TaeonBody.Phalanx = { name="Taeon Tabard", augments={'Phalanx +3',}}
	...
	TaeonGloves = {}
	TaeonGloves.Phalanx = { name="Taeon Gloves", augments={'Phalanx +2',}}
	...
	TaeonTights = {}
	TaeonTights.Phalanx = { name="Taeon Tights", augments={'Phalanx +3',}}
	...
	HerculeanFeet.TA = { name="Herculean Boots", augments={'Attack+19','"Triple Atk."+4','STR+6','Accuracy+9',}}
	...
	TaeonBoots = {}
	TaeonBoots.Phalanx = { name="Taeon Boots", augments={'Phalanx +3',}}
	
	Ogma = {}
	Ogma.TP = { name="Ogma's cape", augments = { 'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Store TP"+10','Phys. dmg. taken-10%', } }
	Ogma.Tank = { name="Ogma's cape", augments={'HP+60','Eva.+20 /Mag. Eva.+20','Enmity+10','Phys. dmg. taken-10%',}} 
	...
	Ogma.FC = { name="Ogma's cape", augments={'VIT+20','Eva.+20 /Mag. Eva.+20','"Fast Cast"+10','Damage taken-5%',}}
...
------End of Magic-------------------------------------------------------------------------------------
	...
	sets.Enhancing.Phalanx = set_combine(sets.Enhancing.Duration, {
		...
		hands = TaeonGloves.Phalanx,
		legs = TaeonTights.Phalanx,
		feet = TaeonBoots.Phalanx,
	})
...
function buff_change(n, gain, buff_table)
    ...
    elseif name == "doom" then
        if gain then
            ...
            send_command('@input /p Doomed o.O!')
	...
	elseif name == "charm" then
		if gain then
			send_command('@input /p Charmed O.o')
		else
